...
export default function AppLayout({ cartCount, profile }) {
  ...
  const displayName = [profile.firstName, profile.lastName].filter(Boolean).join(' ') || 'Book User';
    ...
    <Layout className="book-app-shell">
      ...
      <Layout>
        <Header className="book-app-header">
          <div>
            <Text className="page-kicker">Iteration 1</Text>
          ...
          <Space size={16}>
            ...
            <Space size={10}>
              ...
              <div className="header-user-copy">
                ...
                <Text type="secondary">Frontend Demo</Text>
              </div>
            </Space>
          </Space>
        </Header>
