...
export default function BookDetailPage({ onAddToCart, onQuickPurchase }) {
  ...
  const [quickPurchasing, setQuickPurchasing] = useState(false);
  ...
  async function handleQuickPurchase() {
    setQuickPurchasing(true);
    try {
      await onQuickPurchase(book, quantity);
    } finally {
      setQuickPurchasing(false);
    }
  }
            ...
            <Space orientation="vertical" size={16} style={{ width: '100%' }}>
              ...
              <Descriptions
                ...
                items={[
                  ...
                  { key: 'stock', label: 'Stock', children: book.stock },
