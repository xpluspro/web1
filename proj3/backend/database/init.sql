...
INSERT INTO books (
  slug, title, author, publisher, category, language, isbn, price, stock, status, cover, summary, description, highlights
) VALUES
(
  'refactoring',
  'Refactoring',
...
INSERT INTO users (
  username, password, email, first_name, last_name, twitter, avatar_url, notes, role, disabled, created_at
) VALUES
(
  'tom',
  '123456',
